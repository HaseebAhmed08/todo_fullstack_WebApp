...
const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        ...
        // Extract user ID from session - Better Auth might structure it differently
        ...
        const fetchedTasks = await taskApi.getTasks(userId) as any[];
    ...
    fetchTasks();
  }, [session, authLoading]); // Depend on the whole session object to catch changes
  ...
  const handleToggleComplete = async (id: string) => {
    ...
    try {
      ...
      const updatedTask = await taskApi.updateTask(userId, id, {
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 text-gray-900 bg-white"
